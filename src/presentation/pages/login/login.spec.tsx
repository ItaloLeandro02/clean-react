...
const testStatusForField = (sut: RenderResult, fieldName: string, validationError?: string): void => {
  ...
  expect(dotEmailStatus.className).toBe(validationError ? 'dot danger' : 'dot success')

  const dotPasswordStatus = sut.getByTestId('dot-password-status')
  expect(dotPasswordStatus.className).toBe(validationError ? 'dot danger' : 'dot success')
}
